...
def explain_game(input_screen, screen_color, input_font, font_color):
    ...
    input_font(input_screen, "하는 동물들이 꽤 보이는군요!", font_color, 0, 240, 60)
    input_font(input_screen, "한.. 5마리 정도?", font_color, 0, 300, 60)
    input_font(input_screen, "어서 그들에게 다가가주세요.", font_color, 0, 360, 60)
    input_font(input_screen, "보상은.. 저희가 드리는 보수,", font_color, 0, 420, 60)
    input_font(input_screen, "그리고 뿌듯함을 얻으실겁니다!", font_color, 0, 480, 60)
    menu_music(-1, 1)
